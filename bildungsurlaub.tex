...
%\usepackage{sectsty}  % Formatting the sections bold facing to make 
                       % clear what has been in the original form
...
\item[b)] $\Box$  Wiederholungsantrag
          ...
          Aktenzeichen:      &       \\
          Es liegen wesentliche Änderungen gegen"uber dem 
          Erstantrag vor, und zwar:   & 
                                        $\Box$ keine \\
...
Das diesjährige Programm wird sich nicht wesentlich von dem 
letztjährigen unterscheiden.
...
Sie finden anbei das Programm der letzten Jahre.
Dort finden sie Vorträge wie
"`Patents and copyright and trademarks… Oh, why!?"',
"`Should We Teach The Robot To Kill"',
"`Adapting GNOME for use in the Developing World"',
die die technische und soziale Relevanz aufzeigen.

Dieses Jahr wird der letzten Programme ähnlich sein,
nur mit aktualisierten Themen.

         Die Konferenz hat 15 Jahre Erfahrung mit dem Ausrichten der
          Veranstaltung und waehlt die Themen und die Referenten in 
einem  Peer-Review-Prozess aus.  Dabei werden sowohl fachliche
 Qualifikation, bspw. die durch geschriebenen Code oder Lizenztexten
 nachweisbare Erfahrung, als auch die didaktische Qualifikation, bspw.
          durch nachweisbare Erfahrung als Referent vor grossem 
Publikum, Empfehlungsschreiben oder Gutachten, beruecksichtigt.
